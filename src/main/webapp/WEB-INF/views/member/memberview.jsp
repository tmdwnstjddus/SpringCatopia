...
<head>
    ...
    <!-- Title  -->
    <title>CatWebSite | MemberView</title>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script type="text/javascript">	        	
   	$(function(){
   		$('#btnmemberlist').on('click', function(event){
   			location.href="/catopia/member/memberlist"; 
   			
   		});
   		
   		$('#btnmembertypeset').on('click', function(event){
   			location.href="/catopia/member/membertypeset?memberId=${member.memberId }"; 
