...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://www.goott.co.kr" target="_blank">GoottAcedemy</a> & by<a href="/catopia/home" target="_blank">Catopia</a>
                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/catopia/cat-upload/cat-list">Cat</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/catopia/pr-upload/pr-list?col=all&word=">Product</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/catopia/market/mk-list">Market</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/catopia/re-upload/re-list">Review</a>
                                        </li>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/catopia/qa-upload/qa-list">Q&A</a>
                                        </li>                                        
                                    </ul>
                                </div>
                            </nav>
