            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                      <form id="selectform" action="pr-kind" method="POST">
						<input type="radio" name="kind" value="all" id="kindCategory" <c:if test="${param.kind eq 'all'}"></c:if>/><label for="kindCategory"><h6>ALL</h6></label> <br><br>                 
						<input type="radio" name="kind" value="사료" id="kindCategory2" <c:if test="${param.kind eq '사료'}"></c:if>/><label for="kindCategory2"><h6>Food</h6></label><br><br>
						<input type="radio" name="kind" value="하우스" id="kindCategory3" <c:if test="${param.kind eq '하우스'}"></c:if>/><label for="kindCategory3"><h6>House</h6></label><br><br>						
						<input type="radio" name="kind" value="미용" id="kindCategory4" <c:if test="${param.kind eq '미용'}"></c:if>/><label for="kindCategory4"><h6>Beauty</h6></label><br><br>  						
						<input type="radio" name="kind" value="목욕" id="kindCategory5" <c:if test="${param.kind eq '목욕'}"></c:if>/><label for="kindCategory5"><h6>Bath</h6></label><br><br>     
						<input type="radio" name="kind" value="장난감" id="kindCategory6" <c:if test="${param.kind eq '장난감'}"></c:if>/><label for="kindCategory6"><h6>Toy</h6></label><br><br>
						<input type="radio" name="kind" value="모래" id="kindCategory7" <c:if test="${param.kind eq '모래'}"></c:if>/><label for="kindCategory7"><h6>Sand</h6></label><br><br>  	
						<input type="radio" name="kind" value="캣타워" id="kindCategory8" <c:if test="${param.kind eq '캣타워'}"></c:if>/><label for="kindCategory8"><h6>Tower</h6></label><br><br>   			 				                     
                     </form> 
                </div>
            </div>
          </div>
